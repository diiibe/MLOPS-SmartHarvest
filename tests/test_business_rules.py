...
class TestObservationQuality:
    ...
    def test_perfect_observation_high_confidence(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=100, total_pixels=100, coverage_ratio=1.0, is_small_parcel=False
        )
    ...
    def test_low_coverage_triggers_low_confidence(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=100, total_pixels=100, coverage_ratio=0.59, is_small_parcel=False
        )
    ...
    def test_insufficient_pixels_despite_high_coverage(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=20, total_pixels=20, coverage_ratio=1.0, is_small_parcel=False
        )
    ...
    def test_small_parcel_relaxed_thresholds_pass(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=15, total_pixels=20, coverage_ratio=0.75, is_small_parcel=True
        )
    ...
    def test_small_parcel_below_threshold_fails(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=14, total_pixels=20, coverage_ratio=0.70, is_small_parcel=True
        )
    ...
    def test_boundary_condition_exact_threshold(self):
        ...
        result = evaluate_observation_quality(
            valid_pixels=100, total_pixels=100, coverage_ratio=0.60, is_small_parcel=False
        )
    ...
    def test_observation_quality_parametrized(
        self, valid_pixels, total_pixels, coverage_ratio, is_small, expected
    ):
        ...
        assert result == expected, (
            f"Failed for valid={valid_pixels}, total={total_pixels}, "
            f"coverage={coverage_ratio}, small={is_small}"
        )
...
class TestBusinessRuleEdgeCases:
    ...
    def test_zero_total_pixels(self):
        ...
        try:
            result = evaluate_observation_quality(
                valid_pixels=0, total_pixels=0, coverage_ratio=0.0, is_small_parcel=False
            )
