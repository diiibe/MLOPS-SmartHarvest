...
def create_conn_ee():
    ...
    if os.path.exists(cred):
        ...
        credentials = service_account.Credentials.from_service_account_file(
            cred, scopes=["https://www.googleapis.com/auth/drive", "https://www.googleapis.com/auth/earthengine"]
        )
...
def retrieve_sensor_data(sensor_name, roi, start_date, end_date, **kwargs):
    ...
    col = ee.ImageCollection(sensor_name).filterBounds(roi).filterDate(start_date, end_date)
