...
def analyze_temporal_data():
    ...
    if 'NDVI_Delta' in df.columns:
        ...
        report_lines.append(f"- **NDVI Delta Mean:** {ndvi_delta_mean:.4f} (Expected: close to 0 or slightly negative for senescence)")
    ...
    # Select key features
    key_features = ['NDVI_Peak', 'NDVI_Delta', 'VH_Late', 'VH_Drop', 'Insolation', 'LST_Mean', 'LST', 'Slope']
