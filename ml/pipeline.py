...
def run_ml_pipeline(csv_path, output_base_dir, force_reprocess=False):
    ...
    for week_id, week_start, week_end, obs_count in weeks_to_process:
        ...
        try:
            ...
            cluster_labels_micro, outlier_scores_micro, clusterer = clustering.hdbscan_clustering(
                micro_centroids, micro_sizes
            )
            ...
            track_ids, tracking_info, next_track_id = tracking.track_clusters_simple(
                frame, prev_frame, cluster_labels, prev_labels,
                prev_track_ids, columns['coords']
            )
            ...
            output_paths = output.save_weekly_outputs(
                week_id, frame, cluster_labels, outlier_scores, track_ids,
                ml_dir, columns['coords'], tracking_info
            )
    ...
    if results_summary:
        ...
        return {
            'success': False,
            'error': 'No weeks were successfully processed'
        }
