...
def save_weekly_outputs(week_id, frame, cluster_labels, outlier_scores, track_ids,
                       output_dir, coord_cols, tracking_info=None):
    """
...
def _create_cluster_image(df, week_id, output_dir):
    ...
    try:
        ...
        for i, cluster in enumerate(unique_clusters):
            ...
            ax.scatter(cluster_df['lon'], cluster_df['lat'],
                      c=[colors[i]], label=label, s=10, alpha=0.6)
...
def _create_outlier_image(df, week_id, output_dir):
    ...
    try:
        ...
        scatter = ax.scatter(df['lon'], df['lat'],
                           ...
                           vmin=0, vmax=df['outlier_score'].quantile(0.99))
